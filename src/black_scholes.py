...
class BlackScholesModel:
    ...
    @staticmethod
    def calculate_d1(spot_price, strike_price, time_to_maturity, risk_free_rate, volatility):
        """
    ...
    def call_option_price(self, spot_price, strike_price, time_to_maturity, risk_free_rate, volatility):
        """
        :param spot_price: (float) Current price of the underlying asset (spot price).
        :param strike_price: (float) trike price of the option.
        :param time_to_maturity: (float) Time to maturity (in years).
        ...
        """
        d1 = self.calculate_d1(spot_price, strike_price, time_to_maturity, risk_free_rate, volatility)
        d2 = self.calculate_d2(d1, volatility, time_to_maturity)
        return spot_price * norm.cdf(d1) - strike_price * math.exp(-risk_free_rate * time_to_maturity) * norm.cdf(d2)


    def put_option_price(self, spot_price, strike_price, time_to_maturity, risk_free_rate, volatility):
        """
        :param spot_price: (float) Current price of the underlying asset (spot price).
        :param strike_price: (float) trike price of the option.
        :param time_to_maturity: (float) Time to maturity (in years).
